...
final class PersonUpdatePersonChangeInput
{
    ...
    public function toArray(): array
    {
        return array_filter(
            ...
            'RejectDataStorage' => $this->rejectDataStorage,
            'IdentificationCodeForce' => $this->identificationCodeForce,
            'GenerateSecurityCode' => $this->generateSecurityCode,
            'ID_TempFile' => $this->idTempFile,
            'ID_PersonPhotoBig' => $this->idPersonPhotoBig,
            'ID_PersonPhotoMedium' => $this->idPersonPhotoMedium,
            'ID_PersonPhotoNormal' => $this->idPersonPhotoNormal,
            'ID_PersonPhotoSmall' => $this->idPersonPhotoSmall,
            ],
