...
final class CandidateAllOutput
{
    public function __construct(
        ...
        public readonly ?bool $canSetIsElected = null,
        public readonly ?bool $isPersonWith = null,
        public readonly ?bool $canChangeOrder = null,
        public readonly ?bool $isLeader = null,
        public readonly ?bool $canSetLeader = null,
    ) {}
    ...
    public static function fromStdClass(\stdClass $obj): self
    {
        return new self(
            ...
            canSetIsElected: isset($obj->{'CanSetIsElected'}) ? (bool) $obj->{'CanSetIsElected'} : null,
            isPersonWith: isset($obj->{'IsPersonWith'}) ? (bool) $obj->{'IsPersonWith'} : null,
            canChangeOrder: isset($obj->{'CanChangeOrder'}) ? (bool) $obj->{'CanChangeOrder'} : null,
            isLeader: isset($obj->{'IsLeader'}) ? (bool) $obj->{'IsLeader'} : null,
            canSetLeader: isset($obj->{'CanSetLeader'}) ? (bool) $obj->{'CanSetLeader'} : null,
        );
    }
}
