...
final class ExportFunctionProlongationAllOutput
{
    public function __construct(
        ...
        public readonly ?string $candidateLastTerm = null,
    ...
    public static function fromStdClass(\stdClass $obj): self
    {
        return new self(
            ...
            candidateLastTerm: isset($obj->{'CandidateLastTerm'}) ? (string) $obj->{'CandidateLastTerm'} : null,
