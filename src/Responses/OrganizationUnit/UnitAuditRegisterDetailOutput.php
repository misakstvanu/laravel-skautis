...
final class UnitAuditRegisterDetailOutput
{
    ...
    public static function fromStdClass(\stdClass $obj): self
    {
        return new self(
            ...
            idTempFileReport: isset($obj->{'ID_TempFileReport'}) ? (string) $obj->{'ID_TempFileReport'} : null,
            idTempFileAudit: isset($obj->{'ID_TempFileAudit'}) ? (string) $obj->{'ID_TempFileAudit'} : null,
        );
    }
}
