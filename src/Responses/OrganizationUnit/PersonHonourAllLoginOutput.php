...
final class PersonHonourAllLoginOutput
{
    public function __construct(
        ...
        public readonly ?bool $hasEditPermission = null,
    ) {}
    ...
    public static function fromStdClass(\stdClass $obj): self
    {
        return new self(
            ...
            hasEditPermission: isset($obj->{'HasEditPermission'}) ? (bool) $obj->{'HasEditPermission'} : null,
        );
    }
}
