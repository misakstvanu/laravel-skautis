...
final class DocumentDetailOutput
{
    ...
    public static function fromStdClass(\stdClass $obj): self
    {
        return new self(
            ...
            useCurrentVersion: isset($obj->{'UseCurrentVersion'}) ? (bool) $obj->{'UseCurrentVersion'} : null,
            ...
            cloudValidTo: isset($obj->{'CloudValidTo'}) ? (string) $obj->{'CloudValidTo'} : null,
        );
    }
}
